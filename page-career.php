...
<main>
  ...
  <nav class="p-career-anchor" aria-label="キャリアページ内ナビゲーション">
    <div class="l-inner">
      <ul class="p-career-anchor__list">
        <li class="p-career-anchor__item">
          <a class="p-career-anchor__link" href="#career-path">キャリアパス</a>
        </li>
        <li class="p-career-anchor__item">
          <a class="p-career-anchor__link" href="#support">支援体制</a>
        </li>
        <li class="p-career-anchor__item">
          <a class="p-career-anchor__link" href="#training">研修</a>
        </li>
      </ul>
    </div>
  </nav>
      ...
      <div class="p-career-path__panel js-opacity-word">
        ...
        <div class="p-career-path__flow" aria-label="キャリアパス図">
          <div class="p-career-path__entry">
            <div class="p-career-path__box p-career-path__box--entry">新卒入社</div>
            <div class="p-career-path__box p-career-path__box--entry">中途入社</div>
          </div>
          <figure class="p-career-path__arrow p-career-path__arrow--entry">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/career/career-path-arrow-entry.webp" alt="">
          </figure>
          <div class="p-career-path__jobs">
            <div class="p-career-path__box">モバイルプランナー</div>
            <div class="p-career-path__box">法人営業</div>
            <div class="p-career-path__box">イベント事業</div>
          </div>
          <figure class="p-career-path__arrow p-career-path__arrow--plan">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/career/career-path-arrow-plan.webp" alt="">
          </figure>
          <div class="p-career-path__plans">
            <section class="p-career-path__plan">
              <h3 class="p-career-path__plan-title">マネジメントプラン</h3>
              <p class="p-career-path__plan-text">一人ひとりのマネジメントを通して、お客様に愛される組織創りを追求。キャリアアップに従いマネジメント領域が拡大、組織を動かす組織マネジメント力を体得。</p>
              <ul class="p-career-path__step-list">
                <li class="p-career-path__box">店長</li>
                <li class="p-career-path__box">課長</li>
                <li class="p-career-path__box">事業部長</li>
              </ul>
            </section>
            <section class="p-career-path__plan">
              <h3 class="p-career-path__plan-title">コーポレートデザインプラン</h3>
              <p class="p-career-path__plan-text">「グループ全体を変化させ、人を創る」ことを目的に、働きやすい環境やシステムづくりを提案・実行。適正に応じて部門を選択。</p>
              <ul class="p-career-path__step-list">
            ...
            <section class="p-career-path__plan">
              <h3 class="p-career-path__plan-title">チャレンジプラン</h3>
              <p class="p-career-path__plan-text">自分の能力を試したい方は、グループの垣根を超えてさまざまな仕事に挑戦。幅広い事業経験を習得することで、新規事業の開発へ結びつくことも。</p>
              <ul class="p-career-path__step-list">
                <li class="p-career-path__box">スペシャリスト職</li>
                <li class="p-career-path__box">教育部門</li>
                <li class="p-career-path__box">新規事業開発</li>
              </ul>
            </section>
          </div>
        </div>
    ...
    <div class="l-inner">
      ...
      <div class="p-career-example__profile js-opacity-word">
        ...
        <div class="p-career-example__profile-body">
          <p class="p-career-example__name">山田 崚太</p>
      ...
      <div class="p-career-example__timeline js-opacity-word">
        <article class="p-career-example__step">
          ...
          <p class="p-career-example__text">auショップでの販売業務とKPI管理を担当。販売面の活躍が認められ、フロアマネージャーとしてスタッフのマッチングを行うリーダーへ昇格。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--middle">
          <p class="p-career-example__period">4年〜9年</p>
          <h4 class="p-career-example__step-title">
            <span>副店長・店長として</span>
            <span>店舗マネジメントに挑戦</span>
          </h4>
          <p class="p-career-example__text">別店舗の副店長として立て直しを担い、就任3期目に最高実績を達成。その後、店長としてコロナ禍でも売上を維持し、21卒・22卒を連続で副店長まで育て上げる。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--current">
          <p class="p-career-example__period">9年〜現在</p>
          <h4 class="p-career-example__step-title">モバイル事業部の課長へ抜擢</h4>
          <p class="p-career-example__text">店舗実績の最大化と人財育成、会社文化を体現した指導が評価され課長に抜擢。傘下5店舗の統括と取引先交渉を担い活躍中。</p>
        </article>
      </div>
    </div>
  </section>
    ...
    <div class="l-inner">
      ...
      <div class="p-career-example__timeline js-opacity-word">
        <article class="p-career-example__step">
          ...
          <p class="p-career-example__text">販売スタッフとして店舗実績に貢献。販売実績が評価され副店長としてフロア運営を担当し、スタッフの強みを活かしたマネジメントで店舗全体の生産性向上に貢献。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--middle">
          <p class="p-career-example__period">3年〜8年</p>
          <h4 class="p-career-example__step-title">
            <span>挫折を経て店長再任</span>
            <span>スーパーバイザーへ昇格</span>
          </h4>
          <p class="p-career-example__text">店長として着任するも挫折を経験。再起後、NPS関西上位や半期連続最高評価を達成し、スーパーバイザーへ昇格。イベント事業部立ち上げの基盤を築く。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--current">
          <p class="p-career-example__period">8年〜現在</p>
          <h4 class="p-career-example__step-title">
            <span>イベント事業部の立ち上げと</span>
            <span>部長就任</span>
          </h4>
          <p class="p-career-example__text">事業部を5名から17名規模の自走型組織へと拡大し、日本一の実績を達成。現在はモバイル事業部全体のイベント戦略を担う中核として活躍中。</p>
        </article>
      </div>
    </div>
  </section>
  <section class="p-career-example p-career-example--kaneman">
    <div class="l-inner">
      ...
      <div class="p-career-example__profile js-opacity-word">
        ...
        <div class="p-career-example__profile-body">
          <p class="p-career-example__name">金万 美鈴</p>
      ...
      <div class="p-career-example__timeline js-opacity-word">
        <article class="p-career-example__step">
          ...
          <p class="p-career-example__text">販売スタッフとして従事し、2年連続で新卒の教育係を担当。スタッフへの関わり方が評価され副店長へ昇格。大型イベント運営で大幅な目標達成を実現。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--middle">
          <p class="p-career-example__period">4年〜8年</p>
          <h4 class="p-career-example__step-title">
            <span>店長昇格、接客グランプリにて</span>
            <span>準グランプリ受賞</span>
          </h4>
          <p class="p-career-example__text">店長昇格後の挫折を経て、キャリア実績Sランクを継続獲得する店舗へ成長させる。KDDI主催の接客グランプリではテレックス関西初の準グランプリを受賞。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--current">
          <p class="p-career-example__period">8年〜現在</p>
          <h4 class="p-career-example__step-title">
            <span>イベント事業部へ異動</span>
            <span>社内の旗艦組織を目指す</span>
          </h4>
          <p class="p-career-example__text">事業部を超えた連携で日本一の実績と社内表彰を獲得。人財育成・発掘にも携わり、現在はイベント事業部での活動をベースに、事業部の枠を超えた社内の旗艦組織づくりを目指し活動中。</p>
        </article>
      </div>
    </div>
  </section>
  <section class="p-career-example p-career-example--tanaka">
    <div class="l-inner">
      ...
      <div class="p-career-example__profile js-opacity-word">
        ...
        <div class="p-career-example__profile-body">
          <p class="p-career-example__name">田中 千菜美</p>
      ...
      <div class="p-career-example__timeline js-opacity-word">
        <article class="p-career-example__step">
          ...
          <p class="p-career-example__text">auショップの販売スタッフとして従事。試行錯誤を重ねて提案レベルを高め、同年度新卒1位の販売実績を獲得し最優秀新人賞を受賞。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--middle">
          <p class="p-career-example__period">1年〜3年</p>
          <h4 class="p-career-example__step-title">フロアマネジメントへ抜擢</h4>
          <p class="p-career-example__text">旗艦店舗のフロアマネジメントを担当。後輩育成にも従事し、ブラザーシスター制度で関わった24卒は同年度新卒で最高の売上を獲得。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--current">
          <p class="p-career-example__period">3年〜現在</p>
          <h4 class="p-career-example__step-title">
            <span>人事部の立ち上げ</span>
            <span>メンバーとして抜擢</span>
          </h4>
          <p class="p-career-example__text">モバイル事業部専属の人事部署にて、採用のフロントとして抜擢。販売経験と人への関わり方を活かし、自社採用の最前線で活躍中。</p>
        </article>
      </div>
    </div>
  </section>
  <section class="p-career-example p-career-example--matsumoto">
    <div class="l-inner">
      ...
      <div class="p-career-example__profile js-opacity-word">
        ...
        <div class="p-career-example__profile-body">
          <p class="p-career-example__name">松本 唯花</p>
      ...
      <div class="p-career-example__timeline js-opacity-word">
        <article class="p-career-example__step">
          <p class="p-career-example__period">入社〜1年</p>
          <h4 class="p-career-example__step-title">新卒として入社</h4>
          <p class="p-career-example__text">DSショップの販売スタッフとして従事。高いホスピタリティでお客様の信頼を獲得し、社内新卒接客グランプリで圧倒的な成績で優勝。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--middle">
          <p class="p-career-example__period">1年〜2年</p>
          <h4 class="p-career-example__step-title">
            <span>店舗の主軸として新商材対応や</span>
            <span>後輩育成に従事</span>
          </h4>
          <p class="p-career-example__text">新商材にいち早く対応し、提案の型を店舗内に展開。社内研修にも積極参加し、社内で最も重要とされる新卒研修に2期連続で参加依頼を受ける。</p>
        </article>
        <article class="p-career-example__step p-career-example__step--current">
          <p class="p-career-example__period">2年〜現在</p>
          <h4 class="p-career-example__step-title">社内教育部門へ移籍</h4>
          <p class="p-career-example__text">教える・伝える姿勢が評価され社内教育部門へ移籍。社員向けイベント構築や人事関連などマルチに従事し、責任者向け研修への参加も予定。</p>
        </article>
      </div>
    </div>
  </section>

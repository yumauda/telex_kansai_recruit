...
<main>
  <section class="p-data-mv">
    <div class="p-data-mv__content">
      ...
      <h1 class="p-data-mv__title js-opacity-word">数字で見るテレックス</h1>
    </div>
  </section>
  ...
  <section class="p-data-voice" id="anc02">
    <div class="l-inner">
      <h2 class="p-data-voice__title js-opacity-word">社員に聞いたテレックス関西</h2>
      <div class="p-data-voice__list">
        <p class="p-data-voice__balloon p-data-voice__balloon--left js-opacity-word">人が好き！この人たちがいるから頑張れる！</p>
        <p class="p-data-voice__balloon p-data-voice__balloon--right js-opacity-word">有給を取りやすい雰囲気があるのがいい。<br>休みづらい空気がないので、予定が立てやすいです。</p>
        <p class="p-data-voice__balloon p-data-voice__balloon--left js-opacity-word">男女ともに育休を取ることがあるのがほんとうにありがたいです！<br>ライフイベントがあってもキャリアを続けられるのが嬉しい。</p>
        <p class="p-data-voice__balloon p-data-voice__balloon--right js-opacity-word">成果だけじゃなく“頑張り方”も見てくれるのが救いでした。うまく<br class="u-desktop">いかない時も、改善の過程をちゃんとみてくれるので挑戦しやすい。</p>
        <p class="p-data-voice__balloon p-data-voice__balloon--left js-opacity-word">表彰式（Innovation Ceremony）がイベントじゃなくて目標になります。<br>「来年はここに立ちたい」って自然に思える。</p>
      </div>
    </div>
  </section>

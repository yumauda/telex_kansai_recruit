    ...
    <div class="l-inner">
      ...
      <div class="p-mobile-business-intro__content p-mobile-business-intro__content--work">
        <div class="p-mobile-business-intro__body">
          ...
          <div class="p-mobile-business-intro__text">
            ...
            <ul>
              <li><strong>戦略的なイベント設計：</strong>商業施設などの現場特性に合わせ、集客から成約までの流れを緻密にシミュレーションし、成果を最大化するための導線を設計・実行する。</li>
              <li><strong>自走型チームの運営管理：</strong>役割分担を明確にし、指示待ちではなくメンバーの一人ひとりが自ら考えて動ける「自走する現場」を構築。数字管理と即日改善を徹底する。</li>
              <li><strong>再現性のある組織運営：</strong>現場での成功事例や改善内容を組織内で共有し、特定の個人に依存せず、どの現場でも安定した高パフォーマンスを生み出せる仕組みを運用する。</li>
            </ul>
          </div>
        </div>
      ...
      <div class="p-mobile-business-intro__content p-mobile-business-intro__content--reverse">
        ...
        <div class="p-mobile-business-intro__body">
          ...
          <div class="p-mobile-business-intro__text">
            <ul>
              <li><strong>全国トップを獲る圧倒的な成功体験：</strong>全国販売台数1位（2025年12月度）や5ヶ月連続ベスト5入りなど、全国レベルの成果を自分たちの手で生み出す興奮と達成感を味わえる。</li>
              <li><strong>若手が主役になれる成長スピード：</strong>若手の早期戦力化やインターン育成に力を入れており、社歴に関わらず責任ある役割を任される。挑戦の機会が豊富で、成長が目に見えて実感できる。</li>
              <li><strong>チームで限界を超える一体感：</strong>属人化を排した分業制とチームプレイにより、個人の力を超えた大きな成果を創出。仲間と共に「勝てる仕組み」を形にする楽しさがある。</li>
            </ul>
          </div>
        </div>
      </div>
      <div class="p-mobile-business-intro__content">
        <div class="p-mobile-business-intro__body">
          ...
          <div class="p-mobile-business-intro__text">
            <ul>
              <li><strong>組織力・自走力：</strong>役割を定義し、チームを動かして目標を達成する「組織構築力」と、現場で自ら判断し行動する「自走力」が飛躍的に向上する。</li>
              <li><strong>ロジカルな数値管理・改善スキル：</strong>現場の状況を冷静に分析し、即座に施策へ反映させる「PDCAサイクルを回す力」が身につき、あらゆるビジネスで通用する成果への執着心が養われる。</li>
              <li><strong>人を育てる本質的な教育能力：</strong>実践の中での振り返りや対話を通じ、未経験者を戦力へと引き上げる「育成マインド」が身につき、マネージャーとしての素養を磨くことができる。</li>
            </ul>
          </div>
        </div>
        <figure class="p-mobile-business-intro__image">

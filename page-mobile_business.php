...
<main>
  <section class="p-mobile-business-mv">
    <div class="p-mobile-business-mv__content">
      <p class="p-mobile-business-mv__en js-page-main-title">Mobile business</p>
      <h1 class="p-mobile-business-mv__title js-opacity-word">モバイル事業部</h1>
    </div>
  </section>
  <section class="p-mobile-business-intro">
    <div class="l-inner">
      <h2 class="p-mobile-business-intro__title js-opacity-word">モバイル事業部の仕事紹介</h2>
